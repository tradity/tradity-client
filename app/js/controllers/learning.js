...
//			},
      ...
      //CHANCES AND RISKS
			...
			{
				catalog: 'chances-and-risks',
				description: 'ach einem Jahr, bewertet der Investor seine Entscheidung. Beide Aktien haben eine Wertsteigerung von 20% erfahren, wobei ihre Volatilitäten unverändert sind. Welche der folgenden Aussagen ist richtig?',
				answers: [
      ...
      // TECHNICAL ANALYSIS
		...
		$scope.learningCatalog = [
			...
			},
			{
				...
				description: 'Man unterscheidet grundsätzlich zwischen zwei Arten der Aktienanalyse und Aktienkursen. Zum einen gibt es die 􏰁Fundamentalanalyse􏰀, welche sich mit der Bewertung und dem Erfolg des Unternehmens beschäftigt. Zum anderen gibt es die 􏰁Technische Analyse􏰀, welche die historischen Kursverläufe genauer untersucht. In diesem Kapitel beschäftigen wir uns zunächst mit der Fundamentalanalyse.',
				requirements: [],
			...
			},
  			{
				...
				description: 'Ziel eines guten Investments ist es bei positiven Trendverläufen Gewinne lange wachsen zu lassen und Verluste möglichst zu begrenzen. Doch woher kann man wissen, wann sich die Richtung der Preisentwicklung umkehrt? Die 􏰁Technische Analyse􏰀, also die Betrachtung von historischen Kursver- läufen (sogenannten Charts), kann hierbei hilfreich sein. Zunächst müssen wir aber verstehen, welche Art von Charts es überhaupt gibt und welche sich zur Technischen Analyse eignen.',
				requirements: [],
